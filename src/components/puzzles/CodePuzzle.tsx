...
export const CodePuzzle: React.FC<PuzzleComponentProps> = ({ puzzle, onComplete }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <Card variant="terminal" className="space-y-4">
        ...
        {puzzle.data?.code && (
          <Terminal title="obfuscated.js">
            <div className="space-y-2">
              <div className="text-gray-400">$ cat obfuscated.js</div>
      ...
      <Card variant="default" className="space-y-4">
        <h3 className="text-lg font-mono text-hacker-green">Code Analysis Terminal</h3>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="Enter the access key or secret you found..."
          ...
          {showHint && currentHintIndex > 0 && (
            <Terminal title="code-analysis-hint">
              <div className="space-y-2">
                <div className="text-gray-400">$ node --hint</div>
